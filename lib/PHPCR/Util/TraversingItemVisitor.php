...
abstract class PHPCR_Util_TraversingItemVisitor implements PHPCR_ItemVisitorInterface {
	 ...
	 *
	 * @param PHPCR_ItemInterface $item the Item that is accepting this visitor.
	 * @param integer $level hierarchy level of this node (the root node starts at level 0).
	 * @return void
	 * @throws PHPCR_RepositoryException if an error occurs.
	 * @api
	 */
	protected abstract function entering(PHPCR_ItemInterface $item, $level);
	 ...
	 * @api
	 */
	protected abstract function leaving(PHPCR_ItemInterface $item, $level);
