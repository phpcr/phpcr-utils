...
class jr_cr_versionhistory extends jr_cr_node implements PHPCR_VersionHistoryInterface {
    ...
    public function __construct($JRversionhistory,$session) {
        parent::__construct($this->session,$JRversionhistory);
        $this->JRversionhistory = $JRversionhistory;
    ...
    public function getRootVersion() {
        ...
        return new jr_cr_version($this->JRversionhistory->getRootVersion(),$this->session);
    }
    ...
    public function getAllVersions() {
        return new jr_cr_versioniterator($this->JRversionhistory->getAllVersions(),$this->session);
    }
